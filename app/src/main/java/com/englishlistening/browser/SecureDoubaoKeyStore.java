...
public class SecureDoubaoKeyStore {
    private static final String ANDROID_KEY_STORE = "AndroidKeyStore";
    private static final String ALIAS = "EnglishListeningDoubaoGatewayKey";
    private static final String PREFS = "english_listening_secure_doubao";
    private static final String KEY_CIPHER = "doubao_cipher";
    private static final String KEY_IV = "doubao_iv";

    private final Context context;

    public SecureDoubaoKeyStore(Context context) {
